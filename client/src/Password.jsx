  ...
  return (
    <>
      <div className="h-screen bg-gradient-to-br from-pink-100 to-orange-100 hover:bg-gradient-to-bl space-x-12 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:space-y-0">
        ...
        <div className="2xl:pr-48 2xl:pl-36 xl:pr-24 xl:pl-24">
          <img
            className="2xl:ml-28 2xl:mt-12 2xl:mb-6 xl:ml-40 xl:mt-6 xl:mb-6 2xl:h-36 2xl:w-36 xl:h-28 xl:w-28"
            src="https://marketplace.canva.com/EAFEcdxWgeo/1/0/1600w/canva-elegant-circle-signature-photography-logo--kbTNqEWceg.jpg"
            alt="logo_img"
          />
          <h1 className="text-center mb-8 mt-12 text-blue-800 text-xl">
            <b>
              <i>
                <u>Forgot Password</u>
              </i>
          ...
          <div className="flex flex-col justify-center border-4 hover:border-neutral-300 2xl:px-6 2xl:py-6 xl:px-8 xl:py-8">
