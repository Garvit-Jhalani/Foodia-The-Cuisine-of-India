             ...
             <div className="bg-slate-50">
               ...
               <div className="pl-40">
                 <p className="py-6 text-stone-400">
                  ...
                  10.7km | Rs47 will be applied as Delivery Fee
                </p>
              </div>
            </div>
