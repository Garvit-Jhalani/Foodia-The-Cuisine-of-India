        ...
        <div className="pb-14 pt-96 mt-96 bg-rose-50">
          <div className="relative left-16 right-24 mt-2 rounded-md shadow-sm">
            <input
              ...
              name="Location"
              id="location"
              className="2xl:ml-16 xl:ml-8 block pb-2 pt-2 rounded-lg border-0 pl-8 pr-24 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
