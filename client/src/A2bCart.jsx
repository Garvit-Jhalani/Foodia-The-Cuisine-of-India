...
const a2b = [
  ...
  {
    img: "https://lh3.googleusercontent.com/4Mq06c04iJBH_iLjC0hzFtKw9VcgzjYXolIpwuUdgXMZLni23FCpwP-NSFAvwMlhVy9kR8ZjLTirIpJx0b9fdQUoDHB421KyPQCf-xE=w512-rw",
    title: "Poori [2 Nos]",
    content: "Serves 1 | A delicious Indian breakfast dish comprising of 2 big circular fluffy deep fried wheat flour Pooris served with a mildly spiced vegetable korma and coconut chutney",
    price: "85",
  },
  {
    img: "https://www.vegrecipesofindia.com/wp-content/uploads/2019/01/ven-pongal-recipe-1a.jpg",
    title: "Ghee Pongal",
    content: "Serves 1 | A savory dish made of cooked rice and green gram blended with clarified butter,mildly tempered with spices, garnished with cashews and servedhot",
    price: "100",
  },
  {
             ...
             <div className="bg-slate-50">
               ...
               <div className="pl-40">
                 <p className="py-6 text-stone-400">
                  ...
                  6.7km | Rs46 will be applied as Delivery Fee
                </p>
              </div>
            </div>
