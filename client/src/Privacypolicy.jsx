  ...
  return (
    <>
      ...
      <div className="bg-white w-full">
        ...
        <div className="pb-14 pt-96 mt-96 px-24">

          <p className="pt-8">This Privacy Policy (“Policy”) describes the policies and procedures on the collection, use, disclosure and protection of your information when you use our website located at jiak.com
            The terms “you” and “your” refer to the user of the Jiak Platform. The term “Services” refers to any services offered by Jiak whether on the Jiak Platform or otherwise.
          ...
          <h1 className="pt-4 pb-2 font-bold">Do you have any questions regarding our app?</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Leo duis ut diam quam nulla porttitor massa id neque. Morbi quis commodo odio aenean sed adipiscing diam. Dignissim enim sit amet venenatis urna. In massa tempor nec feugiat nisl pretium fusce id. Felis imperdiet proin fermentum leo vel orci. Nulla aliquet porttitor lacus luctus accumsan. Aliquet risus feugiat in ante metus dictum at. Urna molestie at elementum eu facilisis sed odio morbi quis.</p>
