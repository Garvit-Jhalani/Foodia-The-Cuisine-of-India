...
const Udupi = [
  ...
  {
    img: "https://images.immediate.co.uk/production/volatile/sites/30/2020/08/chopped-green-salad-with-herby-chilli-dressing-429ab82.jpg?quality=90&resize=500,454",
    title: "Green Salad",
    content: "Serves 1",
    price: "100",
  },
          ...
          <div className="absolute left-0 right-0 top-24 pb-2 pt-2 ml-0 grid grid-flow-col gap-2 justify-left bg-slate-50 ">
             <div className="bg-slate-50">
               <p className="text-xs text-stone-400 pl-40 py-8">
                 Home / Jaipur / Udupi Sagar
               </p>
               <h1 className="text-3xl pl-40 text-4xl font-mono">
                <b>Udupi Sagar</b>
               </h1>
               <p className="text-sm pl-40 text-stone-400">Veg Restraunt</p>
               ...
               <div className="pl-40">
                 <p className="py-6 text-stone-400">
                  ...
                  1.7km | Rs34 will be applied as Delivery Fee
                </p>
              </div>
            </div>
