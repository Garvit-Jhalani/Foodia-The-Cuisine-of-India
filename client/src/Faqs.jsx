    ...
    <>
      ...
      <div className="bg-white w-full">
        <div className="2xl:pb-48 xl:pb-36">
          <div className="absolute left-0 right-0 top-24 pb-2 pt-2 ml-0 bg-orange-100 grid grid-flow-col gap-2 justify-left bg-orange-100">
        ...
        <div className="pb-14 pt-96 mt-8">
          <div className=" bg-white w-full px-8 py-14 mx-auto mt-20 space-y-2 shadow lg:max-w-md">
            <details className="p-4 rounded-lg">
              ...
              <div className="mt-3">
                <p className="text-sm leading-6 text-gray-600">
                  <b>Answer:</b> You have already created an account but you can't remember your password? Click on 'Login/Sign Up' at the top of the page. Then click on 'Forgot Password?'. Fill out your phone number and a password recovery will be sent to you by phone.
                </p>
              </div>
            </details>
            <details className="p-4 rounded-lg">
            ...
            <details className="p-4 rounded-lg">
              ...
              <div className="mt-3">
                <p className="text-sm leading-6 text-gray-600">
                  <b>Answer:</b> After you place your order, it is sent immediately to the bliss kitchen, which starts preparing it without any delay. The kitchen does everything to process your order as quickly as possible. However, sometimes Blissmeal receives large amount of orders, or drivers get stuck in heavy traffic this might cause little delays. If the amount of time you've waited has exceeded the estimated delivery time, you may please contact us. You will a receive an SMS as soon as your order is dispatched.
                </p>
              </div>
            </details>
            <details className="p-4 rounded-lg">
              <summary className="font-semibold">
                Q-4 How to order online at www.Jaik.com ?
              </summary>
              <div className="mt-3">
                <p className="text-sm leading-6 text-gray-600">
                  <b>Answer:</b> It is really easy, as easy as 1, 2, 3... <br />
                  i. Tell us where you are: enter your location so that we know your address to deliver your order. <br />
                  ii. Choose what you would like: select items you'd like to order. You can search by cuisine type, dish name. <br />
            ...
            <details className="p-4 rounded-lg">
              ...
              <div className="mt-3">
                <p className="text-sm leading-6 text-gray-600">
                  <b>Answer:</b> Please check once in your text message. If not, please share the details via customer Support team. Mail Id: customercare@jiak.com Phone No: +91 - 722 502 1674
                </p>
              </div>
            </details>
          </div>
